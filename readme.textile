...
First let's see that this actually works. I've create a macro called <code>quick-snippet</code> which loads a widget and analyzes it produce the right code. Instead writing out the whole template you can write the following:
...
Wow. Without changing a line of Enlive, I've built a whole new level of functionality <i>on top of</i> Enlive.
...
When a macro is executed you are not handed "values" you're simply handle whatever symbols or expressions are present in the code. This is a common error to think you are being handed values. You are always transforming code not the values present in your program.
