...
Say hello to your first Lisp template. syntax-quote allows us to template in values with ~ (called "unquote"). Again if you have done some HTML templating this should not be so alien to you.
...
Wow. ~@ lets us splice in a sequence of values! ~@ is called splicing unquote. When transform code this is a particularly useful operation.
